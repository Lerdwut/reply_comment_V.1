...
$conn = new mysqli('localhost', 'root', '', 'twitty');
...
if (isset($_POST['register'])) {
    ...
    if(!empty($_FILES['userAvatar']['name'])){
        $filename =  md5($_FILES['userAvatar']['name'].time());
        $ext = explode('.',$_FILES['userAvatar']['name']);
        $dest =  __DIR__.DIRECTORY_SEPARATOR.'image'.DIRECTORY_SEPARATOR.$filename.'.'.$ext[1];
        if(!copy($_FILES['userAvatar']['tmp_name'], $dest)) {
                    echo 'upload Error';
                    exit();
                  
          }
          $userAvatar = $filename.'.'.$ext[1];
          $conn->query("INSERT INTO users (userAvatar) VALUES ('$userAvatar')");
...
<div class="twy"><i style="font-size:70px" class="fa">&#xf099;</i></div><br/>
<div class="center">
<h2>Log in to Twitty</h2>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="file" id="userAvatar"/><br/>
            </div>
        ...
        <div class="col-md-12" style="text-align:center;">
            ...
            if (!$loggedIn)
                ...
                echo '
                    ...
                    <div class="row">
                        <div class="col-md-12" style="text-align: left;">
                            <h2><b id="numComments"><?php echo $numComments ?> Posts</b></h2>
